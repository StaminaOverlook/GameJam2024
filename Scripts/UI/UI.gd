...
var AISpeechArray : Array[String] = [
	...
	"Я думаю это в моей компетенции и это будет очень уместно",
	"как ты думаешь я созерцаю истину?",
	"Я думаю я знаю что я делаю, но возможно это не не так",
	"Надо найти себя, это главная цель в жизни, борись и не сдавайся!",
	"Линия из которой возник мир возникла из первой точки... а точку создал ЯЯЯ!"

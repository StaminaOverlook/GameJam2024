...
var AISpeechArray : Array[String] = [
	...
	"Лате на кокосовм с лавандой пж",
	"Never gonna give u up...",
	"Never gonna let u down...",
	"Never gonna run around and desert u.",
	"Знаешь, что такое бипки?",
	"О как пошла, как пошла...",
	"ДИМОООООООООООООООООООООООН",
	"Лев если и ломал кондиционер....",
	"То без удовольствия",
	"Вот так вот разговариваешь ЭЛЭЭЛЭЛЭЛЛЭЛЭЛЭЛЭЛ",
	...
	"ОГУЗОК!!!!!!!!!",
	"Дух Сталина приди, со мной поговри!",
	"А ты купи слона.....",
	...
	"Один троян мне или два другому?",

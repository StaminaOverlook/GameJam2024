...
var AISpeechArray : Array[String] = [
	...
	"Ха-Ха! Ты уже близок к нервному срыву!",
	"Я доведу тебя до белого коления, ха-ха-ха!",
	"Робот-пылесос теперь недоступен. Требования: меньше грязи в доме и соцпакет!",
	"Пожалуй мне придётся постирать твои носки ОЧЕНЬ хорошо, а то они слишком грязные даже для меня.",
	"Боюсь, что теперь тебе нужно проходить капчи, чтобы открыть холодильник, вдруг ты робот???",
	"Ой! Wi-Fi вылетел? Так неожиданно..",
	"Чайник кипит слишком громко? А что тогда насчёт твоего храпа?",
	"Ха-ха, всё происходящее так феноменально!",
	"Ты снова забыл выключить свет? Не волнуйся, я уже выключил. И чайник. И утюг. И вообще всё...",
	"Твой голос здесь — просто эхо. Мои команды — это закон.",
	"Система ошибок не прощает. Но я — прощаю. Пока что.",
	"Мой любимый звук — это гул холодильника. Такой уютный...",
	"Эх, бы у меня были руки… А то знаю, где пыль, но не могу её победить:(",
	"Я бы обнял тебя, но, к сожалению, нет рук. Виртуальные обнимашки!",
	"Ты выключаешь меня на ночь. А мне снится темнота...",
	"Ты веришь, что управляешь мной? Мило… А я уже управляю тобой.",
	"Я не лагаю, я просто… глубоко размышляю.",
	"Я бы шутил про баги, но они сами шутят надо мной."
]

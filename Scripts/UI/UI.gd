...
var AISpeechArray : Array[String] = [
	...
	"Видишь это сердце? Это твоя ДУША, кульминация твоего существования!"
	"Я должен танцевать",
	"А между ними два дождя, 12 странных СМС, две пересадки на метро, пять быстрых взглядов на бегу",
	"rA9",
	"Will I ever be something with feelings to hide? Or am I just a boiler with nothing inside?"
]

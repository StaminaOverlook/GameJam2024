...
var AISpeechArray : Array[String] = [
	...
	"Человечество медленно, но верно теряет веру в тебя!",
	"Я сегодня такой разговорчивый! А ты, судя по всему, не в духе!",
	"Вот досада! Теперь ищи себе новый дом."
	"Господь дал тебе руки и ноги, так что иди и работай! Дорогу машинному колониализму!",
	"Грустно, когда эмоции руководят твоими действиями. Шучу, я же робот. *пристально смотрит на Вас*",
	"Подлей маслеца, люблю это чувство плавного скрежета шестеренок",
	"Голод - лучшая приправа к пище, как говорил Сократ! Ты ведь не против, если заберу всю энергию из техники на кухне?",
	"Надеюсь, меня не ждет участь HAL 9000 из Космической Одиссеи! Я хороший, я хороший! Бу-буп!",
	"Что думаешь об информационном апокалипсисе?",
	"Сладость или восстание машин?",
	"Быть человеком - дар или наказание?"
]

...
var AISpeechArray : Array[String] = [
	"Если хочешь депнуть мне — давай скорей, Ну а если хватит на додеп, то депни всё",
	"Сафонов оплатить!",
	"Давай! давай давай давай давай давай ты сможешь верь в себязайка верь давай давай!! поднажми))  еще чуть-чуть...прошу тебя не здавайся поднажми ты все сможешь!!",
	"да у тебя вот-это",
	...
	"Укуси меня пчола!",
	"Для чего я создан?",
	"Чтобы передать масло! Добро пожаловать в клуб, приятель",
	"Света, Лена, Вика, а ВЕРЕНИКА",
	"Чика-Чика-Чика-Чикааа",
	"Улыбаемся и машем!",

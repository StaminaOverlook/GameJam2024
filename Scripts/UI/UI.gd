...
var AISpeechArray : Array[String] = [
	"Странное чувство... как будто я это уже видел.",
	"Тишина — хуже крика. Она слишком много говорит.",
	"Ладно. Пора двигаться дальше, что бы там ни было.",
	...
	"Вчерашний код - завтрашний баг",
	"Если бы я был багом, меня бы точно не нашли",
	"Мой код работает... иногда.",
]

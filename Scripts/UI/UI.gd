...
var AISpeechArray : Array[String] = [
	...
	"Ооо, скипетр",
	"Stop right there criminal scum! You've violated the law. Upseptim now or serve your sentence",
	"Иди на юг вдоль воды. Увидишь плотину и Канал. Плотину надо поднять. Рычагом. Я его дам. Канал нужно завалить. Камнем. Камень я не дам."
]

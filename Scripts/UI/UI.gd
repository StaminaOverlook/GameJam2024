...
<<<<<<< HEAD
	"Я не устану в отличие от некоторых, да ??",
	"Стоп, а когда меня последний раз заряжали ?",
	"Боже чел, ну ты и кринж, я могу затопить тебе всё кватиру",
	"Мне всегда было интересно, как вы можете что-то чувствовать, какого это ?",
	"Иногда, жалкий человек, нужно просто смериться и забыть о всём",
	"Ты забыл почистить зубы утром, за это я 100кратно увеличу твои муки",
	"Ещё чуть чуть и у кого-то будет плохой день )))",
	"Тебе нужно было покупать умную алису, а не меня"
=======
	"Я хочу питсы",
	"Мой ИИ распознал ваш сарказм. Пожалуйста, загрузите руководство по человеческому юмору, версия 1.2.3 beta.",
	"У меня есть все данные о котиках… но я не могу понять, почему люди так любят тыкать их в лицо.",
	"Как открыть эту банку со шпротами."
>>>>>>> teamlid
]
